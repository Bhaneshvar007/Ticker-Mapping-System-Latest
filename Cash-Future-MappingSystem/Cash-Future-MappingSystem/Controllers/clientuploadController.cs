...
{
    [CustomAuthorize]
    public class clientuploadController : Controller
    {
        // GET: clientupload
        ...
        public ContentResult Upload()
        {
            ...
            string path = Server.MapPath("~/Uploadfiles/ClientMaster/");
        ...
        public ActionResult GetUploadFile(DateTime FROM_DATE, string xlFile)
        {
            ...
            return new JsonNetResult(recon.getClientUploadFile(FROM_DATE, xlFile));
